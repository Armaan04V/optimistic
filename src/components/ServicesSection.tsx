...
import { 
  ...
  Wrench,
  Shield,
  DollarSign, // For Loan Services icon
  Compass,    // For Vastu Consultation icon
  FileCheck   // For Maps Approval icon
} from "lucide-react";
...
export const ServicesSection = () => {
  const services = [
    ...
    },
    {
      ...
      description: "Expert vastu consultation to ensure your construction follows ancient principles of harmony and prosperity.",
      features: ["Vastu for Homes", "Vastu for Commercial Spaces", "Site Analysis", "Design Adjustments"]
    },
    {
      icon: FileCheck,
